...
##  PSStackParser
##
class PSStackParser(PSBaseParser, Log):
        ...
        while not self.results:
            ...
            if isinstance(token, (int, long, float, bool, str, PSLiteral)):
                ...
                try:
                    ...
                    #SlayerNEO patch: do not quit when malformed dictionaries are found
                    if len(objs) % 2 != 0:
                        self.logger.warning("Found an object with an invalid dictionary")
